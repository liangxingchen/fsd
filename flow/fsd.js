declare module fsd {
  ...
  declare class FSDFile {
    ...
    writePart(partTask: string, data: string | Buffer | stream$Readable, size?: number): Promise<string>;
  ...
  declare class Adapter {
    ...
    writePart(path: string, partTask: string, data: stream$Readable, size: number): Promise<string>;
